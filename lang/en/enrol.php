...
$string['customwelcomemessageplaceholder'] = '<div style="background-color: aliceblue;padding: 10px;font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <div style="padding: 10px;">
        <p>Dear {$a->firstname},</p>
        
        <p>We\'re pleased to inform you that you have been successfully enrolled in the {$a->coursename}</p>
