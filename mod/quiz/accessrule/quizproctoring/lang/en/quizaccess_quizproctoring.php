...
$string['enableproctoring'] = 'Enable webcam with this quiz';
...
$string['help_timeinterval'] = 'Select time interval for image Webcam';
...
$string['pluginname'] = 'Webcam quiz access rule';
$string['privacy:metadata'] = 'The Webcam quiz access rule plugin does not store any personal data.';
$string['proctoring_image_show'] = 'Show Webcam Images';
$string['proctoring_image_show_help'] = 'If set, Proctoring Images can be displayed on review attempt page in a popup.';
$string['proctoring_videolink'] = "Quiz webcam video link";
$string['proctoringerror'] = 'This quiz has been set up so that it may only be attempted using the webcam.';
$string['proctoringidentity'] = 'Webcam Identity';
$string['proctoringimagereport'] = 'Webcam {$a} overall Report';
$string['proctoringimages'] = 'Webcam Images';
$string['proctoringlink'] = 'Webcam video link';
$string['proctoringlink_help'] = "Please add video link for demovideo of quiz webcam.";
$string['proctoringnotice'] = 'This quiz has been configured so that candidates may only attempt it using the Webcam.';
...
$string['quizproctoring:quizproctoringonlinestudent'] = 'View Online Students during webcam';
$string['quizproctoring:quizproctoringoverallreport'] = 'View webcam Report';
$string['quizproctoring:quizproctoringreport'] = 'View webcam Images and webcam Identity buttons';
...
$string['storeallimages_help'] = 'Enable this option to store all captured images during webcam sessions, not just warning images.';
...
$string['viewproctoringreport'] = 'View webcam Report';
