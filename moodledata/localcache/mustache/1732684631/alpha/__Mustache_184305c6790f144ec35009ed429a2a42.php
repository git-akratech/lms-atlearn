...
class __Mustache_184305c6790f144ec35009ed429a2a42 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section49f14748a3959bba52e3fce1984ea7ea($context, $indent, $value);
    ...
    private function section49f14748a3959bba52e3fce1984ea7ea(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    {{$drawerheadercontent}}
    {{> theme_alpha/courseindexdrawercontrols}}
    {{/drawerheadercontent}}
...
';
                ...
                if ($parent = $this->mustache->loadPartial('theme_alpha/drawer-left')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawerheadercontent' => array($this, 'blockF56ae37fdcb974c4841bb3ae57bae97d'),
    ...
    public function blockF56ae37fdcb974c4841bb3ae57bae97d($context)
    {
        $indent = $buffer = '';
        if ($partial = $this->mustache->loadPartial('theme_alpha/courseindexdrawercontrols')) {
