...
class __Mustache_529a3c6ee61cb3f4aee9c584342c95d6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div
';
        $buffer .= $indent . '    class="d-flex flex-row align-items-start m-1 ';
        ...
        $buffer .= $this->section0752f8156530c1cd768a60dd58f53706($context, $indent, $value);
        $buffer .= '"
';
...
';
        $buffer .= $indent . '>
';
        $buffer .= $indent . '    <div class="option-name w-100">
';
        $buffer .= $indent . '        <a
';
        $buffer .= $indent . '            class="stretched-link text-wrap font-weight-bold py-1 pl-2 ';
        $buffer .= ' ';
        $value = $context->find('disabled');
        if (empty($value)) {
...
';
        ...
        $buffer .= $this->section3717bd32aa250ad1d2ca2df5b48bb346($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <div>
';
...
';
        $value = $context->find('description');
        $buffer .= $this->section9de672d3eec5356b7700656e7da29ee1($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section0752f8156530c1cd768a60dd58f53706(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' option-selected-bg selected ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= ' option-selected-bg selected ';
                $context->pop();
            }
        }
...
';
    ...
    private function section3717bd32aa250ad1d2ca2df5b48bb346(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <div class="option-icon mx-2">
';
                $buffer .= $indent . '                ';
                $value = $context->find('pix');
...
';
    ...
    private function section9de672d3eec5356b7700656e7da29ee1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '                        class="option-description small text-wrap">
';
                $buffer .= $indent . '                        ';
