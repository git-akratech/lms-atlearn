...
class __Mustache_52f5ee3e4703562a135f8c23a116db7a extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="custom-control custom-switch hidden" data-region="delete-messages-for-all-users-toggle-container">
';
        $buffer .= $indent . '        <input type="checkbox" class="custom-control-input" id="delete-messages-for-all-users">
';
        $buffer .= $indent . '        <label class="custom-control-label" for="delete-messages-for-all-users">
';
        $buffer .= $indent . '            ';
