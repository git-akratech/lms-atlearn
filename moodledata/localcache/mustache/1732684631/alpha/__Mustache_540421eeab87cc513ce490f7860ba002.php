...
class __Mustache_540421eeab87cc513ce490f7860ba002 extends Mustache_Template
{
...
';
        ...
        $value = $context->find('header');
        $buffer .= $this->section4e67ff4fda1e67dc0f89db0ff2597756($context, $indent, $value);
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function sectionB3526400ab876972b596b644d8e18ac2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                        ...
                        $buffer .= '"
';
                        $buffer .= $indent . '                           class="btn btn-icon btn-light d-flex align-items-center justify-content-center icon-no-margin"
';
                        $buffer .= $indent . '                           title="';
                        $value = $context->find('str');
                        $buffer .= $this->section70fc2265f21857283760f122a5c52abf($context, $indent, $value);
...
';
    ...
    private function section4e67ff4fda1e67dc0f89db0ff2597756(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionB3526400ab876972b596b644d8e18ac2($context, $indent, $value);
                $context->pop();
            }
        }
