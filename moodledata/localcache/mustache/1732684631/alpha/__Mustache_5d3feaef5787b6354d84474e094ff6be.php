...
class __Mustache_5d3feaef5787b6354d84474e094ff6be extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionBc95d000d00c7e3311776806a7f76f1b($context, $indent, $value);
        $value = $context->find('component');
        if (empty($value)) {
...
';
    ...
    private function sectionBc95d000d00c7e3311776806a7f76f1b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
