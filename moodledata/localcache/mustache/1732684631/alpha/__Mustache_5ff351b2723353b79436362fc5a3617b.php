...
class __Mustache_5ff351b2723353b79436362fc5a3617b extends Mustache_Template
{
...
';
        ...
        $buffer .= '" class="rui-icon-no-margin btn btn-icon btn-secondary" href="#">
';
...
';
        $buffer .= $indent . '                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.25 19.25H6.75C5.64543 19.25 4.75 18.3546 4.75 17.25V7.75H17.25C18.3546 7.75 19.25 8.64543 19.25 9.75V12.25"></path>
';
...
';
        ...
        $buffer .= '" class="rui-icon-no-margin btn btn-icon btn-info" href="#">
';
        $buffer .= $indent . '                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
';
...
';
        $buffer .= $indent . '                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 14.25L12 4.75"></path>
';
        $buffer .= $indent . '                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8.75 10.75L12 14.25L15.25 10.75"></path>
';
        $buffer .= $indent . '                        </svg>
';
        $buffer .= $indent . '                    </a>
...
';
        ...
        $buffer .= '" class="fp-vb-icons rui-icon-no-margin btn btn-icon btn-secondary" href="#">
';
        $buffer .= $indent . '                    <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
';
...
';
        ...
        $buffer .= '" class="fp-vb-details rui-icon-no-margin btn btn-icon btn-secondary" href="#">
';
        $buffer .= $indent . '                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
';
        $buffer .= $indent . '                        <path d="M7.75 5.75H16.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
';
        $buffer .= $indent . '                        <path d="M7.75 18.25H16.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
';
...
';
        ...
        $buffer .= '" class="fp-vb-tree rui-icon-no-margin btn btn-icon btn-secondary" href="#">
';
        $buffer .= $indent . '                    <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
';
        $buffer .= $indent . '                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.25 17.25V9.75C19.25 8.64543 18.3546 7.75 17.25 7.75H4.75V17.25C4.75 18.3546 5.64543 19.25 6.75 19.25H17.25C18.3546 19.25 19.25 18.3546 19.25 17.25Z"/>
';
        $buffer .= $indent . '                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13.5 7.5L12.5685 5.7923C12.2181 5.14977 11.5446 4.75 10.8127 4.75H6.75C5.64543 4.75 4.75 5.64543 4.75 6.75V11"/>
';
        $buffer .= $indent . '                    </svg>
';
        $buffer .= $indent . '                </a>
