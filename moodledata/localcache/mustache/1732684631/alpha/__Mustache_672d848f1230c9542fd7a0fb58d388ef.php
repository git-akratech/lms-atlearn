...
class __Mustache_672d848f1230c9542fd7a0fb58d388ef extends Mustache_Template
{
...
';
        $buffer .= $indent . '        >
';
        $buffer .= $indent . '            <span class="rui-message-accordion-toggle-icon" role="button" aria-label="';
...
';
        ...
        $buffer .= '</span>
';
        $buffer .= $indent . '                <svg height="5" viewBox="0 0 9 5" width="9" xmlns="http://www.w3.org/2000/svg"><path d="m.5810971 12h7.47401829c.51705218 0 .77557827.6245293.40957504.9905325l-3.73555675 3.7384616c-.22657343.2265734-.59548144.2265734-.82205487 0l-3.73555675-3.7384616c-.36600323-.3660032-.10747714-.9905325.40957504-.9905325z" fill="currentColor" transform="translate(0 -12)"/></svg>
';
        $buffer .= $indent . '            </span>
';
...
';
        $buffer .= $indent . '            <small
';
        $buffer .= $indent . '                class="hidden ml-auto"
';
...
';
        $buffer .= $indent . '            >
';
        $buffer .= $indent . '                <span class="rui-message-badge mr-2" data-region="section-total-count-container" aria-labelledby="';
        $blockFunction = $context->findInBlock('region');
        if (is_callable($blockFunction)) {
            $buffer .= call_user_func($blockFunction, $context);
        }
...
';
        $buffer .= $indent . '                    </span>
';
        $buffer .= $indent . '                    <span aria-hidden="true" data-region="section-total-count" class="rui-message-total-count">';
...
';
        ...
        $buffer .= ' badge badge-xs badge-primary"
';
