...
class __Mustache_6debf1069041923e6a886951a3a6ef2c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAb6d7899ac96df21adfe3795876a04fc($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function section582d2c7cb9371cafb8a44d0768e9fdf1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionAb6d7899ac96df21adfe3795876a04fc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section582d2c7cb9371cafb8a44d0768e9fdf1($context, $indent, $value);
                $context->pop();
            }
        }
