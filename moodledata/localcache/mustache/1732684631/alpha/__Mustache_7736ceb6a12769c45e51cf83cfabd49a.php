...
class __Mustache_7736ceb6a12769c45e51cf83cfabd49a extends Mustache_Template
{
...
';
        ...
        $value = $this->resolveValue($context->findDot('output.render_lang_menu_login'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '</div>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div id="page-login" class="container-fluid p-0 ';
        $value = $context->findDot('output.render_lang_menu_login');
        $buffer .= $this->sectionBfcaab25ea05d2591292d1e9311fd3d9($context, $indent, $value);
        $buffer .= '">
';
...
';
    ...
    private function sectionBfcaab25ea05d2591292d1e9311fd3d9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'rui-multilang';
