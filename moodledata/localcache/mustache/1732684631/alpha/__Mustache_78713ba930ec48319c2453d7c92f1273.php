...
class __Mustache_78713ba930ec48319c2453d7c92f1273 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <button id="message-drawer-toggle-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '" class="rui-topbar-special-btn rui-tooltip--bottom border-0"
';
...
';
        $buffer .= $indent . '        <div
';
        $buffer .= $indent . '            class="count-container rui-unreadcount ';
...
';
        ...
        $buffer .= $this->sectionA333645f3207905703f04e550afee293($context, $indent, $value);
    ...
    private function sectionA333645f3207905703f04e550afee293(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
