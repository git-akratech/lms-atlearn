...
class __Mustache_8939a02bf3874a2ead1875f32aa3d68d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF6d8b917f9972cf88065b2e08c878091($context, $indent, $value);
...
';
    ...
    private function section7eafcf1c734acc56575fc0f6098a02a7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <a
        href="{{{url}}}"
        class="add-sections btn btn-sm btn-primary mb-3"
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '        class="add-sections btn btn-sm btn-primary mb-3"
';
...
';
    ...
    private function sectionF6d8b917f9972cf88065b2e08c878091(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section7eafcf1c734acc56575fc0f6098a02a7($context, $indent, $value);
                $buffer .= $indent . '</div>
';
                $context->pop();
            }
