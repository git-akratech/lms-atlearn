...
class __Mustache_a8a09a521887f802427443de89512dbf extends Mustache_Template
{
...
';
        $buffer .= $indent . '            class="btn btn-sm btn-secondary rui-icon-no-margin category-button selected"
';
...
';
        $buffer .= $indent . '        <button
';
        $buffer .= $indent . '            class="btn btn-sm btn-secondary rui-icon-no-margin category-button"
';
        $buffer .= $indent . '            data-action="show-category"
';
...
';
        $buffer .= $indent . '        <button
';
        $buffer .= $indent . '            class="btn btn-secondary rui-icon-no-margin category-button mr-1"
';
        $buffer .= $indent . '            data-action="show-category"
';
