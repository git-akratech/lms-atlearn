...
class __Mustache_a92a1ea4ba627bc786bcdf9dccc8ec11 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if (empty($value)) {
            ...
            $buffer .= '" role="none" class="dropdown-item ';
...
';
        ...
        $value = $context->find('disabled');
        $buffer .= $this->sectionC898bb63015675e6afd2bad96d63d60d($context, $indent, $value);
...
';
    ...
    private function sectionC898bb63015675e6afd2bad96d63d60d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
    <span class="dropdown-item currentlink" role="none">{{#icon}}{{#pix}}{{key}},{{component}},{{title}}{{/pix}}{{/icon}}{{{text}}}</span>
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '    <span class="dropdown-item currentlink" role="none">';
                $value = $context->find('icon');
