...
class __Mustache_ac25862a8de89095a3b0db0d803b2315 extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div class="course-section-header d-flex flex-wrap align-items-center"
';
