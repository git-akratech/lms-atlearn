...
class __Mustache_aeb2c98ec60554d4709eebbb084dd404 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'blockFeba2c73e4b83e79907326aa0f301c38'),
            ));
...
';
    ...
    public function blockFeba2c73e4b83e79907326aa0f301c38($context)
    {
        $indent = $buffer = '';
...
';
        $buffer .= $indent . '                    <a class="btn-msg-danger" data-action="closedrawer" href="#"
';
        $buffer .= $indent . '                    title="';
