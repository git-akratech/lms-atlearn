...
class __Mustache_b4ae86530eba96cdca00d4b33f80afe3 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</div>
';
        $buffer .= $indent . '            <button class="btn btn-primary ms-2" data-action="copytoclipboard" data-clipboard-target="#copytoclipboardtoken" data-clipboard-success-message="';
        $value = $context->find('str');
