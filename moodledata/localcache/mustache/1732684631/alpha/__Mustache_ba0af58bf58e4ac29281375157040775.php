...
class __Mustache_ba0af58bf58e4ac29281375157040775 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                    <label class="form-control-label my-0 mr-md-2 col-sm-12 col-md-4">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                    <div class="form-control-label my-0 mr-md-2 col-sm-12 col-md-4 d-inline-flex align-items-center">
';
