...
class __Mustache_fbf6cf672dd5e4f9b337a53a30f5fec3 extends Mustache_Template
{
...
';
        $buffer .= $indent . '<div class="hidden pt-2" data-region="more-courses-button-container">
';
        $buffer .= $indent . '    <button type="button" class="btn btn-sm btn-secondary w-100" data-action="more-courses">
';
        $buffer .= $indent . '        ';
