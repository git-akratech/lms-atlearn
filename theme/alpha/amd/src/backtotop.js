 ...
 *
 * @module     theme_alpha/backtotopbutton
 * @copyright  2023 Marcin Czaja
 * @copyright  based on code from theme_alpha_campus by Kathrin Osswald.
 ...
 */
 ...
 define(['jquery', 'core/str', 'core/notification'], function($, str, Notification) {
    ...
    function initBackToTop() {
        ...
        let stringsPromise = str.get_string('backtotopbutton', 'theme_alpha');
