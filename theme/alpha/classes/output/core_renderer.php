    ...
    */
    ...
    protected function courseprogress($course) {
        ...
        if (get_class($courseformat) != 'format_tiles') {
            ...
            if ($completion->is_enabled()) {
                ...
                if (get_config('theme_monocolor', 'courseprogressbar') == 1) {
                    $progressbar = '<div class="rui-course-progresschart">' .
                        $this->render_from_template('theme_monocolor/progress-chart', $templatedata) .
                        '</div>';
    ...
    public function mainsidebarmenu() {
        ...
        if ($theme->settings->iscustomitem1on == true) {
            ...
            $customitemrole1 = theme_alpha_get_setting("customitemrole1");
        ...
        if ($theme->settings->iscustomitem2on == true) {
            ...
            // User role restriction.
            $customitemrole2 = theme_alpha_get_setting("customitemrole2");
        ...
        if ($theme->settings->iscustomitem3on == true) {
            ...
            // User role restriction.
            $customitemrole3 = theme_alpha_get_setting("customitemrole3");
        ...
        if ($theme->settings->iscustomitem4on == true) {
            ...
            // User role restriction.
            $customitemrole4 = theme_alpha_get_setting("customitemrole4");
        ...
        if ($theme->settings->iscustomitem5on == true) {
            ...
            // User role restriction.
            $customitemrole5 = theme_alpha_get_setting("customitemrole5");
            ...
            $customitem3_allowed_roles = array('manager', 'editingteacher','teacher');
            ...
            $headerlinks = array(
                ...
                "9" => array(
                    ...
                    'status' => $iscustomitem4on && $can_see_customitem4,
    ...
    public function alpha_mycourses() {
        ...
        $displayfilterhiddenchbx = theme_alpha_get_setting('displayfilterhiddenchbx');
    ...
    public function moremenu_custom_items () {
        ...
        $theme = \theme_config::load('alpha');
        $html = '';
        $secnavcount = theme_alpha_get_setting('secnavitemscount');
        ...
        if ($this->page->theme->settings->secnavitems == 1) {
            ...
            for ($i = 1; $i <= $secnavcount; $i++) {
                $secnav->title = theme_alpha_get_setting("secnavcustomnavlabel" . $i);

                $url = theme_alpha_get_setting("secnavcustomnavurl" . $i);
                $courseid = $COURSE->id;
                $newurl = str_replace("{{courseID}}", $courseid, $url);
                $secnav->url = $newurl;
                
                // User role restriction.
                $selectrole = theme_alpha_get_setting("secnavuserrole" . $i);
    ...
    public function render_custom_reports_menu() {
        ...
        if ($is_manager || $is_editingteacher) {
            return '
