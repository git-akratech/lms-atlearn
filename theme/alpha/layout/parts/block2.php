...
$block2herotitle = format_text(theme_alpha_get_setting("block2herotitle"), FORMAT_HTML, array('noclean' => true));
$block2herosubheading = format_text(theme_alpha_get_setting("block2herosubheading"), FORMAT_HTML, array('noclean' => true));
$block2herocaption = format_text(theme_alpha_get_setting("block2herocaption"), FORMAT_HTML, array('noclean' => true));
$block2herocss = theme_alpha_get_setting("block2herocss");
...
if (theme_alpha_get_setting('block2fw') == '1') {
    echo '<div id="fbblock2" class="wrapper-fw rui-fp-block--2 rui-fp-margin-bottom mt-3 ' . $block2class . '">';
} else {
    echo '<div id="fbblock2" class="wrapper-xl rui-fp-block--2 rui-fp-margin-bottom mt-3 ' . $block2class . '">';
}
